...
public final class ItemOrderBinding implements ViewBinding {
  ...
  private ItemOrderBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvCustomer,
      @NonNull TextView tvDate, @NonNull TextView tvStatus, @NonNull TextView tvTotal) {
  ...
  public static ItemOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemOrderBinding((MaterialCardView) rootView, tvCustomer, tvDate, tvStatus,
          tvTotal);
    }
